...
function Home() {
  ...
  const handleSearchClick = () => {
    if (searchTerm) {
      ...
      router.push(`./services/Pages/install?model=${encodeURIComponent(searchPath)}`); // Navigate to the install page
    } else {
...
>
  ...
  <div className="relative z-10">
    {/* <h1 className="text-white">Your Content Here</h1> */}
        ...
        <div className="max-w-screen-xl mx-auto 2xl:max-w-[1496px]">
          <h1 className="text-[18px] w-full max-w-[832px] mt-[100px] text-[#737373]">
